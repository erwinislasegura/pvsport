...
?>
<style>
  :root{--catalogo-menu-color:<?= e($colorPrimario) ?>;--primary:<?= e($colorPrimario) ?>;--accent:<?= e($colorAcento) ?>;--bg:#eef2f7;--border:#dbe3ee;--text:#0f172a;--muted:#64748b;--shadow:0 10px 25px rgba(15,23,42,.08)}
