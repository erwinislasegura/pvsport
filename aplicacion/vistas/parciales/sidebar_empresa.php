...
<aside class="sidebar sidebar-app p-3 border-end bg-white">
  ...
  <nav class="nav flex-column small gap-2">
    ...
    <?php if ($tieneModulo('modulo_catalogo_en_linea')): ?><a class="nav-link d-flex gap-2 <?= $coincideRuta('/app/configurador-paletas', $rutaActual) ? 'active' : '' ?>" href="<?= e(url('/app/configurador-paletas')) ?>"><i class="bi bi-sliders2 mt-1"></i><span>Configurador paletas</span></a><?php endif; ?>
