...
use Aplicacion\Controladores\Publico\ConfiguradorPaletasControlador;
...
$enrutador->agregar('GET', '/blog', [PublicoControlador::class, 'catalogoBlogPorDominio']);
$enrutador->agregar('GET', '/faq-tenis-de-mesa-chile', [PublicoControlador::class, 'catalogoFaqSeoPorDominio']);
$enrutador->agregar('GET', '/tenis-de-mesa-chile', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/ping-pong-chile', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/paletas-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/paletas-ping-pong', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/gomas-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/gomas-ping-pong', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/mesas-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/mesa-ping-pong', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/pelotas-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/accesorios-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/implementos-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/maderas-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/redes-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/fundas-y-protectores', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/robots-de-entrenamiento', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/tenis-de-mesa-principiantes', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/tenis-de-mesa-profesional', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
$enrutador->agregar('GET', '/implementacion-tenis-de-mesa', [PublicoControlador::class, 'catalogoLandingSeoPorDominio']);
...
$enrutador->agregar('GET', '/catalogo/configurador-paletas', [ConfiguradorPaletasControlador::class, 'landingPorDominio']);
$enrutador->agregar('GET', '/configurador-paletas', [ConfiguradorPaletasControlador::class, 'landingPorDominio']);
...
$enrutador->agregar('GET', '/catalogo/{empresaId}/configurador-paletas', [ConfiguradorPaletasControlador::class, 'landing']);
$enrutador->agregar('POST', '/catalogo/{empresaId}/configurador-paletas/recomendar', [ConfiguradorPaletasControlador::class, 'recomendar']);
$enrutador->agregar('POST', '/catalogo/{empresaId}/configurador-paletas/guardar', [ConfiguradorPaletasControlador::class, 'guardarBuild']);
